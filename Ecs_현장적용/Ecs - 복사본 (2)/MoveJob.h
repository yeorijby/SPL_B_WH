...
public:
	...
	CString GetDestPos2();
	CString GetDestPos2(int nDestPos);
...
public:
	...
	CMoveJobItem* BufferLineLastCheck(int nSetLine, int nLineSeq, CString strCodNum);

	BOOL FetchRgvJobRetrieve(int nTrackNum, CMoveJobItem** pFetchJobItem1, CMoveJobItem** pFetchJobItem2);
	int	 BufferLineCountCheck(int nSetLine, int nLineSeq, int nLuggNum);
