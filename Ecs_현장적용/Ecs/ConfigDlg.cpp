...
void CConfigDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT_CV_PORT9, m_nCvPort9);
	...
	DDX_Check(pDX, IDC_CHECK_CV_CONNECT9, m_bCvConnect9);
	...
	DDX_Check(pDX, IDC_CHECK_CV_RETRY9, m_bCvRetry9);
	DDX_Check(pDX, IDC_CHECK_ECS_RETRY, m_bEcsRetry);

	DDX_Text(pDX, IDC_EDIT_SC_PORT1, m_nScPort1);
	DDX_Check(pDX, IDC_CHECK_SC_CONNECT1, m_bScConnect1);
	DDX_Check(pDX, IDC_CHECK_SC_RETRY1, m_bScRetry1);

	DDX_Text(pDX, IDC_EDIT_SC_PORT2, m_nScPort2);
	DDX_Check(pDX, IDC_CHECK_SC_CONNECT2, m_bScConnect2);
	DDX_Check(pDX, IDC_CHECK_SC_RETRY2, m_bScRetry2);

	DDX_Text(pDX, IDC_EDIT_SC_PORT3, m_nScPort3);
	DDX_Check(pDX, IDC_CHECK_SC_CONNECT3, m_bScConnect3);
	DDX_Check(pDX, IDC_CHECK_SC_RETRY3, m_bScRetry3);

	DDX_Text(pDX, IDC_EDIT_SC_PORT4, m_nScPort4);
	DDX_Check(pDX, IDC_CHECK_SC_CONNECT4, m_bScConnect4);
	DDX_Check(pDX, IDC_CHECK_SC_RETRY4, m_bScRetry4);

	DDX_Text(pDX, IDC_EDIT_SC_PORT5, m_nScPort5);
	DDX_Check(pDX, IDC_CHECK_SC_CONNECT5, m_bScConnect5);
	DDX_Check(pDX, IDC_CHECK_SC_RETRY5, m_bScRetry5);

	DDX_Text(pDX, IDC_EDIT_SC_PORT6, m_nScPort6);
	DDX_Check(pDX, IDC_CHECK_SC_CONNECT6, m_bScConnect6);
	DDX_Check(pDX, IDC_CHECK_SC_RETRY6, m_bScRetry6);
...
BOOL CConfigDlg::OnInitDialog() 
{
	...
	m_nCvPort9 = m_pConfig->m_sCvPort[8].nPort;
	...
	m_bCvConnect9 = m_pConfig->m_sCvPort[8].bConnect;
	...
	m_bCvRetry9 = m_pConfig->m_sCvPort[8].bRetry;
	m_bEcsRetry = m_pConfig->m_bEcsRetry;

	m_nScPort1 = m_pConfig->m_sScPort[0].nPort;
	m_bScConnect1 = m_pConfig->m_sScPort[0].bConnect;
	m_bScRetry1 = m_pConfig->m_sScPort[0].bRetry;

	m_nScPort2 = m_pConfig->m_sScPort[1].nPort;
	m_bScConnect2 = m_pConfig->m_sScPort[1].bConnect;
	m_bScRetry2 = m_pConfig->m_sScPort[1].bRetry;

	m_nScPort3 = m_pConfig->m_sScPort[2].nPort;
	m_bScConnect3 = m_pConfig->m_sScPort[2].bConnect;
	m_bScRetry3 = m_pConfig->m_sScPort[2].bRetry;

	m_nScPort4 = m_pConfig->m_sScPort[3].nPort;
	m_bScConnect4 = m_pConfig->m_sScPort[3].bConnect;
	m_bScRetry4 = m_pConfig->m_sScPort[3].bRetry;

	m_nScPort5 = m_pConfig->m_sScPort[4].nPort;
	m_bScConnect5 = m_pConfig->m_sScPort[4].bConnect;
	m_bScRetry5 = m_pConfig->m_sScPort[4].bRetry;


	m_nScPort6 = m_pConfig->m_sScPort[5].nPort;
	m_bScConnect6 = m_pConfig->m_sScPort[5].bConnect;
	m_bScRetry6 = m_pConfig->m_sScPort[5].bRetry;
	...
	SetDlgItemText(IDC_EDIT_CV_ADDR9, m_pConfig->m_sCvPort[8].strAddress);

	SetDlgItemText(IDC_EDIT_ECS_ADDR, m_pConfig->m_strEcsAddr);

	for(int i = 0 ; i < SC_CNT ; i++)
	{
		SetDlgItemText(IDC_EDIT_SC_ADDR1+i, m_pConfig->m_sScPort[i].strAddress);
	}
/*
	SetDlgItemText(IDC_EDIT_SC_ADDR1, m_pConfig->m_sScPort[0].strAddress);
	SetDlgItemText(IDC_EDIT_SC_ADDR2, m_pConfig->m_sScPort[1].strAddress);
	SetDlgItemText(IDC_EDIT_SC_ADDR3, m_pConfig->m_sScPort[2].strAddress);
	SetDlgItemText(IDC_EDIT_SC_ADDR4, m_pConfig->m_sScPort[3].strAddress);
	SetDlgItemText(IDC_EDIT_SC_ADDR5, m_pConfig->m_sScPort[4].strAddress);
	SetDlgItemText(IDC_EDIT_SC_ADDR6, m_pConfig->m_sScPort[5].strAddress);
*/
...
void CConfigDlg::OnButtonSave() 
{
	...
	GetDlgItemText(IDC_EDIT_CV_ADDR9, strAddr);			
	m_pConfig->m_sCvPort[8].strAddress = strAddr;
	...
	m_pConfig->m_sCvPort[8].nPort = m_nCvPort9;
	...
	m_pConfig->m_sCvPort[8].bConnect	= m_bCvConnect9;
	...
	m_pConfig->m_sCvPort[8].bRetry = m_bCvRetry9;

	m_pConfig->m_bEcsRetry	 = m_bEcsRetry;


	GetDlgItemText(IDC_EDIT_SC_ADDR1, strAddr);
	m_pConfig->m_sScPort[0].strAddress = strAddr;
	
	m_pConfig->m_sScPort[0].nPort  = m_nScPort1;
	m_pConfig->m_sScPort[0].bConnect = m_bScConnect1;
	m_pConfig->m_sScPort[0].bRetry = m_bScRetry1;


	GetDlgItemText(IDC_EDIT_SC_ADDR2, strAddr);
	m_pConfig->m_sScPort[1].strAddress = strAddr;
	
	m_pConfig->m_sScPort[1].nPort  = m_nScPort2;
	m_pConfig->m_sScPort[1].bConnect = m_bScConnect2;
	m_pConfig->m_sScPort[1].bRetry = m_bScRetry2;


	GetDlgItemText(IDC_EDIT_SC_ADDR3, strAddr);
	m_pConfig->m_sScPort[2].strAddress = strAddr;
	
	m_pConfig->m_sScPort[2].nPort  = m_nScPort3;
	m_pConfig->m_sScPort[2].bConnect = m_bScConnect3;
	m_pConfig->m_sScPort[2].bRetry = m_bScRetry3;

	GetDlgItemText(IDC_EDIT_SC_ADDR4, strAddr);
	m_pConfig->m_sScPort[3].strAddress = strAddr;
	
	m_pConfig->m_sScPort[3].nPort  = m_nScPort4;
	m_pConfig->m_sScPort[3].bConnect = m_bScConnect4;
	m_pConfig->m_sScPort[3].bRetry = m_bScRetry4;


	GetDlgItemText(IDC_EDIT_SC_ADDR5, strAddr);
	m_pConfig->m_sScPort[4].strAddress = strAddr;
	
	m_pConfig->m_sScPort[4].nPort  = m_nScPort5;
	m_pConfig->m_sScPort[4].bConnect = m_bScConnect5;
	m_pConfig->m_sScPort[4].bRetry = m_bScRetry5;


	GetDlgItemText(IDC_EDIT_SC_ADDR6, strAddr);
	m_pConfig->m_sScPort[5].strAddress = strAddr;

	m_pConfig->m_sScPort[5].nPort  = m_nScPort6;
	m_pConfig->m_sScPort[5].bConnect = m_bScConnect6;
	m_pConfig->m_sScPort[5].bRetry = m_bScRetry6;
