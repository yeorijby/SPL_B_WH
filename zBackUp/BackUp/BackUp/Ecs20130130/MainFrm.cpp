...
{
	m_wndToolBar.SetButtonInfo(20 + unID - ID_COMM_SC_1, unID, TBBS_BUTTON, GetIndex(Status));
}

void CMainFrame::UpdateCommRgv(UINT unID, char Status) 
{
	m_wndToolBar.SetButtonInfo(27 + unID - ID_COMM_RGV_1, unID, TBBS_BUTTON, GetIndex(Status));
}

void CMainFrame::UpdateCommEcsCl(char Status)
{
	m_wndToolBar.SetButtonInfo(30, ID_COMM_NEW_ECS, TBBS_BUTTON, GetIndex(Status));
}
