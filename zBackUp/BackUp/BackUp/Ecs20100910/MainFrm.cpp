...
{
	m_wndToolBar.SetButtonInfo(19 + unID - ID_COMM_SC_1, unID, TBBS_BUTTON, GetIndex(Status));
}

void CMainFrame::UpdateCommRgv(UINT unID, char Status) 
{
	m_wndToolBar.SetButtonInfo(26 + unID - ID_COMM_RGV_1, unID, TBBS_BUTTON, GetIndex(Status));
}

void CMainFrame::UpdateCommEcsCl(char Status)
{
	m_wndToolBar.SetButtonInfo(29, ID_COMM_NEW_ECS, TBBS_BUTTON, GetIndex(Status));
}
