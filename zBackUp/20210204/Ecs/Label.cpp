...
void CLabel::FalshHelp(COLORREF crHelp)
{
	m_crHelp = crHelp;
...
void CLabel::OnLButtonUp(UINT nFlags, CPoint point) 
{
	...
	{
		/*
		int nLen = strLink.GetLength();
		for(int i = 0; i < nLen; i++)
		{
			if(strLink.GetAt(i) == 0x40)
				strLink.SetAt(i, NULL);
		}
		strLink = CString("mailto:") + (LPCTSTR)strLink + CString("@www.samoh.com");
		*/
