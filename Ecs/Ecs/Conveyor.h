...
public:
    ...
    void ParsingFrame9(BYTE *pRxBuff, int nFromTrackNum, int nCnt);
	...
	void ArriveDataCopy();
	void LineCountCheck();
	void LineCountCheck3();
	void LineCountCheck4(); //미사용
	...
	void CvDataChange8GroupTo9Group();
	void CvDataChange8GroupTo9Group2();
	void CvDataChange9GroupTo8Group();
	void CvDataChange1GroupTo9Group();
	void CvDataChange1GroupTo9Group2();
	...
	void RemoveCvData8Group2();
	void RemoveCvData8GroupTo9Group();
	void RemoveCvData9GroupTo8Group(); //임시방편 
	...
	void ParsingStatus9(BYTE *pRxBuff);
