...
*/
	...
	static int nLine101 = -1;
	static int nLine102 = -1;
	static int nLine103 = -1;
	static int nLine104 = -1;
	static int nLine105 = -1;
	static int nLine106 = -1;
	static int nLine107 = -1;
	static int nLine108 = -1;
	...
	if (nLine101 != pDoc->m_nSetLine2[0] )
	{
		nLine101 = pDoc->m_nSetLine2[0];

		strTem.Format("%d", pDoc->m_nSetLine2[0]);
		SET(IDC_EDIT_SET_LINE101, strTem );
	}

	if (nLine102 != pDoc->m_nSetLine2[1] )
	{
		nLine102 = pDoc->m_nSetLine2[1];

		strTem.Format("%d", pDoc->m_nSetLine2[1]);
		SET(IDC_EDIT_SET_LINE102, strTem );
	}

	if (nLine103 != pDoc->m_nSetLine2[2] )
	{
		nLine103 = pDoc->m_nSetLine2[2];

		strTem.Format("%d", pDoc->m_nSetLine2[2]);
		SET(IDC_EDIT_SET_LINE103, strTem );
	}

	if (nLine104 != pDoc->m_nSetLine2[3] )
	{
		nLine104 = pDoc->m_nSetLine2[3];

		strTem.Format("%d", pDoc->m_nSetLine2[3]);
		SET(IDC_EDIT_SET_LINE104, strTem );
	}

	if (nLine105 != pDoc->m_nSetLine2[4] )
	{
		nLine105 = pDoc->m_nSetLine2[4];

		strTem.Format("%d", pDoc->m_nSetLine2[4]);
		SET(IDC_EDIT_SET_LINE105, strTem );
	}

	if (nLine106 != pDoc->m_nSetLine2[5] )
	{
		nLine106 = pDoc->m_nSetLine2[5];

		strTem.Format("%d", pDoc->m_nSetLine2[5]);
		SET(IDC_EDIT_SET_LINE106, strTem );
	}

	if (nLine107 != pDoc->m_nSetLine2[6] )
	{
		nLine107 = pDoc->m_nSetLine2[6];

		strTem.Format("%d", pDoc->m_nSetLine2[6]);
		SET(IDC_EDIT_SET_LINE107, strTem );
	}

	if (nLine108 != pDoc->m_nSetLine2[7] )
	{
		nLine108 = pDoc->m_nSetLine2[7];

		strTem.Format("%d", pDoc->m_nSetLine2[7]);
		SET(IDC_EDIT_SET_LINE108, strTem );
	}
	...
	static int nCount101 = -1;
	static int nCount102 = -1;
	static int nCount103 = -1;
	static int nCount104 = -1;
	static int nCount105 = -1;
	static int nCount106 = -1;
	static int nCount107 = -1;
	static int nCount108 = -1;
	...
	if (nCount101 != pDoc->m_nSetLineCount2[0] )
	{
		nCount101 = pDoc->m_nSetLineCount2[0];

		strTem.Format("%d", pDoc->m_nSetLineCount2[0]);
		SET(IDC_EDIT_SET_COUNT101, strTem );
	}

	if (nCount102 != pDoc->m_nSetLineCount2[1] )
	{
		nCount102 = pDoc->m_nSetLineCount2[1];

		strTem.Format("%d", pDoc->m_nSetLineCount2[1]);
		SET(IDC_EDIT_SET_COUNT102, strTem );
	}

	if (nCount103 != pDoc->m_nSetLineCount2[2] )
	{
		nCount103 = pDoc->m_nSetLineCount2[2];

		strTem.Format("%d", pDoc->m_nSetLineCount2[2]);
		SET(IDC_EDIT_SET_COUNT103, strTem );
	}

	if (nCount104 != pDoc->m_nSetLineCount2[3] )
	{
		nCount104 = pDoc->m_nSetLineCount2[3];

		strTem.Format("%d", pDoc->m_nSetLineCount2[3]);
		SET(IDC_EDIT_SET_COUNT104, strTem );
	}

	if (nCount105 != pDoc->m_nSetLineCount2[4] )
	{
		nCount105 = pDoc->m_nSetLineCount2[4];

		strTem.Format("%d", pDoc->m_nSetLineCount2[4]);
		SET(IDC_EDIT_SET_COUNT105, strTem );
	}

	if (nCount106 != pDoc->m_nSetLineCount2[5] )
	{
		nCount106 = pDoc->m_nSetLineCount2[5];

		strTem.Format("%d", pDoc->m_nSetLineCount2[5]);
		SET(IDC_EDIT_SET_COUNT106, strTem );
	}

	if (nCount107 != pDoc->m_nSetLineCount2[6] )
	{
		nCount107 = pDoc->m_nSetLineCount2[6];

		strTem.Format("%d", pDoc->m_nSetLineCount2[6]);
		SET(IDC_EDIT_SET_COUNT107, strTem );
	}

	if (nCount108 != pDoc->m_nSetLineCount2[7] )
	{
		nCount108 = pDoc->m_nSetLineCount2[7];

		strTem.Format("%d", pDoc->m_nSetLineCount2[7]);
		SET(IDC_EDIT_SET_COUNT108, strTem );
	}
	...
	if(pDoc->m_bSetLineCheck2 == FALSE)
	{
		...
		GetDlgItem(IDC_EDIT_SET_LINE101)->EnableWindow(FALSE);
		GetDlgItem(IDC_EDIT_SET_LINE102)->EnableWindow(FALSE);
		GetDlgItem(IDC_EDIT_SET_LINE103)->EnableWindow(FALSE);
		GetDlgItem(IDC_EDIT_SET_LINE104)->EnableWindow(FALSE);
		GetDlgItem(IDC_EDIT_SET_LINE105)->EnableWindow(FALSE);
		GetDlgItem(IDC_EDIT_SET_LINE106)->EnableWindow(FALSE);
		GetDlgItem(IDC_EDIT_SET_LINE107)->EnableWindow(FALSE);
		GetDlgItem(IDC_EDIT_SET_LINE108)->EnableWindow(FALSE);
	...
	if(pDoc->m_bSetLineCheck2 == TRUE)
	{
		...
		GetDlgItem(IDC_EDIT_SET_LINE101)->EnableWindow(TRUE);
		GetDlgItem(IDC_EDIT_SET_LINE102)->EnableWindow(TRUE);
		GetDlgItem(IDC_EDIT_SET_LINE103)->EnableWindow(TRUE);
		GetDlgItem(IDC_EDIT_SET_LINE104)->EnableWindow(TRUE);
		GetDlgItem(IDC_EDIT_SET_LINE105)->EnableWindow(TRUE);
		GetDlgItem(IDC_EDIT_SET_LINE106)->EnableWindow(TRUE);
		GetDlgItem(IDC_EDIT_SET_LINE107)->EnableWindow(TRUE);
		GetDlgItem(IDC_EDIT_SET_LINE108)->EnableWindow(TRUE);
	...
	{
		m_bCountCheck = FALSE;
		GetDlgItem(IDC_EDIT_SET_COUNT101)->EnableWindow(FALSE);
		GetDlgItem(IDC_EDIT_SET_COUNT102)->EnableWindow(FALSE);
		GetDlgItem(IDC_EDIT_SET_COUNT103)->EnableWindow(FALSE);
		GetDlgItem(IDC_EDIT_SET_COUNT104)->EnableWindow(FALSE);
		GetDlgItem(IDC_EDIT_SET_COUNT105)->EnableWindow(FALSE);
		GetDlgItem(IDC_EDIT_SET_COUNT106)->EnableWindow(FALSE);	
		GetDlgItem(IDC_EDIT_SET_COUNT107)->EnableWindow(FALSE);
		GetDlgItem(IDC_EDIT_SET_COUNT108)->EnableWindow(FALSE);
	...
	if(pDoc->m_bSetCountCheck == TRUE)
	{
		...
		GetDlgItem(IDC_EDIT_SET_COUNT101)->EnableWindow(TRUE);
		GetDlgItem(IDC_EDIT_SET_COUNT102)->EnableWindow(TRUE);
		GetDlgItem(IDC_EDIT_SET_COUNT103)->EnableWindow(TRUE);
		GetDlgItem(IDC_EDIT_SET_COUNT104)->EnableWindow(TRUE);
		GetDlgItem(IDC_EDIT_SET_COUNT105)->EnableWindow(TRUE);
		GetDlgItem(IDC_EDIT_SET_COUNT106)->EnableWindow(TRUE);
		GetDlgItem(IDC_EDIT_SET_COUNT107)->EnableWindow(TRUE);
		GetDlgItem(IDC_EDIT_SET_COUNT108)->EnableWindow(TRUE);
...
BEGIN_EVENTSINK_MAP(CEcsView, CFormView)
	...
	ON_EVENT(CEcsView, IDC_CVCTRL2120, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2121, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2122, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2123, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2124, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2125, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2126, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2127, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2128, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2130, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2131, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2132, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2133, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2134, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2135, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2136, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2137, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2138, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2140, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2141, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2142, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2143, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2144, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2145, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2146, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2147, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2148, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2150, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2151, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2152, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2153, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2154, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2155, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2156, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2157, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2158, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2160, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2161, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2162, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2163, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2164, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2165, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2166, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2167, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2168, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2170, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2171, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2172, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2173, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2174, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2175, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2176, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2177, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2178, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2180, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2181, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2182, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2183, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2184, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2185, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2186, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2187, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2188, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2190, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2191, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2192, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2193, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2194, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2195, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2196, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2197, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2198, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	...
	ON_EVENT(CEcsView, IDC_CVCTRL2260, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2261, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2262, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2263, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2264, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2265, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2266, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2267, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	...
	ON_EVENT(CEcsView, IDC_CVCTRL2274, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2275, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2276, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRL2277, 1 /* LBtnClick */, OnLBtnClickConveyor, VTS_I2)
	...
	ON_EVENT(CEcsView, IDC_CVCTRLGOING1, 1 /* LBtnClick */, OnLBtnClickBufferController, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRLGOING2, 1 /* LBtnClick */, OnLBtnClickBufferController, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRLGOING3, 1 /* LBtnClick */, OnLBtnClickBufferController, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRLGOING4, 1 /* LBtnClick */, OnLBtnClickBufferController, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRLGOING5, 1 /* LBtnClick */, OnLBtnClickBufferController, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRLGOING6, 1 /* LBtnClick */, OnLBtnClickBufferController, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRLGOING7, 1 /* LBtnClick */, OnLBtnClickBufferController, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRLGOING8, 1 /* LBtnClick */, OnLBtnClickBufferController, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRLGOING9, 1 /* LBtnClick */, OnLBtnClickBufferController, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRLGOING10, 1 /* LBtnClick */, OnLBtnClickBufferController, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRLGOING11, 1 /* LBtnClick */, OnLBtnClickBufferController, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRLGOING12, 1 /* LBtnClick */, OnLBtnClickBufferController, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRLGOING13, 1 /* LBtnClick */, OnLBtnClickBufferController, VTS_I2)
	ON_EVENT(CEcsView, IDC_CVCTRLGOING14, 1 /* LBtnClick */, OnLBtnClickBufferController, VTS_I2)
...
//		else
	...
	CCvControl* pBufferController;
	for (i = IDC_CVCTRLGOING1; i < IDC_CVCTRLGOING1 + 14; i++ )
	{
		pBufferController = (CCvControl *)GetDlgItem(i);
		if ( pBufferController == NULL ) 
			continue;

		pBufferController->SetID(i - IDC_CVCTRLGOING1);

		strBttName.Format("C/V BufferController #%d", i - IDC_CVCTRLGOING1  + 1);
		//strBttName.Format("RTV #%d", i - IDC_RTVCTRL1  + 1);
		m_bttWnd.AddTool(GetDlgItem(i), strBttName);
	}
...
void CEcsView::OnCheckSetLine2() 
{
	...
	if(pDoc->m_bSetLineCheck2 == FALSE)
	{
		GET(IDC_EDIT_SET_LINE101, strTemp);
		pDoc->m_ConveyorThreadInfo[CV_9_PLC].m_ConveyorTroubleMsg.nD[0] = atoi(strTemp);

		GET(IDC_EDIT_SET_LINE102, strTemp);
		pDoc->m_ConveyorThreadInfo[CV_9_PLC].m_ConveyorTroubleMsg.nD[1] = atoi(strTemp);

		GET(IDC_EDIT_SET_LINE103, strTemp);
		pDoc->m_ConveyorThreadInfo[CV_9_PLC].m_ConveyorTroubleMsg.nD[2] = atoi(strTemp);

		GET(IDC_EDIT_SET_LINE104, strTemp);
		pDoc->m_ConveyorThreadInfo[CV_9_PLC].m_ConveyorTroubleMsg.nD[3] = atoi(strTemp);

		GET(IDC_EDIT_SET_LINE105, strTemp);
		pDoc->m_ConveyorThreadInfo[CV_9_PLC].m_ConveyorTroubleMsg.nD[4] = atoi(strTemp);

		GET(IDC_EDIT_SET_LINE106, strTemp);
		pDoc->m_ConveyorThreadInfo[CV_9_PLC].m_ConveyorTroubleMsg.nD[5] = atoi(strTemp);

		GET(IDC_EDIT_SET_LINE107, strTemp);
		pDoc->m_ConveyorThreadInfo[CV_9_PLC].m_ConveyorTroubleMsg.nD[6] = atoi(strTemp);

		GET(IDC_EDIT_SET_LINE108, strTemp);
		pDoc->m_ConveyorThreadInfo[CV_9_PLC].m_ConveyorTroubleMsg.nD[7] = atoi(strTemp);
...
void CEcsView::OnCheckChangeCount() 
{
	...
	if(pDoc->m_bSetCountCheck == FALSE)
	{
		GET(IDC_EDIT_SET_COUNT101, strTemp);
		pDoc->m_nSetLineCount2[0] = atoi(strTemp);

		GET(IDC_EDIT_SET_COUNT102, strTemp);
		pDoc->m_nSetLineCount2[1] = atoi(strTemp);

		GET(IDC_EDIT_SET_COUNT103, strTemp);
		pDoc->m_nSetLineCount2[2] = atoi(strTemp);

		GET(IDC_EDIT_SET_COUNT104, strTemp);
		pDoc->m_nSetLineCount2[3] = atoi(strTemp);

		GET(IDC_EDIT_SET_COUNT105, strTemp);
		pDoc->m_nSetLineCount2[4] = atoi(strTemp);

		GET(IDC_EDIT_SET_COUNT106, strTemp);
		pDoc->m_nSetLineCount2[5] = atoi(strTemp);

		GET(IDC_EDIT_SET_COUNT107, strTemp);
		pDoc->m_nSetLineCount2[6] = atoi(strTemp);

		GET(IDC_EDIT_SET_COUNT108, strTemp);
		pDoc->m_nSetLineCount2[7] = atoi(strTemp);
